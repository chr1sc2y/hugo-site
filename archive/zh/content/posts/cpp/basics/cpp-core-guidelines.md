...
date: 2023-02-01T14:11:00+08:00
draft: true
categories: ["C++"]
tags: ["cpp", "core-guidelines"]
---
...
**原因**：编译器和许多程序员都不会阅读你的评论或者设计文档。代码中的内容已经定义了语义，并且可以被编译器和其他工具检测。
...
3. 对于仅用作输入的参数，如果拷贝操作的开销很小（比如普通数据类型），使用 pass by value 的形式
